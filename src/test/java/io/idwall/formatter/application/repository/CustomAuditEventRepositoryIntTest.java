package io.idwall.formatter.application.repository;

import io.idwall.formatter.application.IdwallFormatterApp;
import io.idwall.formatter.application.config.Constants;
import io.idwall.formatter.application.config.audit.AuditEventConverter;
import io.idwall.formatter.application.domain.PersistentAuditEvent;
...
import static io.idwall.formatter.application.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
