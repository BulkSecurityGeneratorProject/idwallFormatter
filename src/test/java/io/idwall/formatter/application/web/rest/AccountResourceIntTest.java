package io.idwall.formatter.application.web.rest;

import io.idwall.formatter.application.config.Constants;
import io.idwall.formatter.application.IdwallFormatterApp;
import io.idwall.formatter.application.domain.Authority;
import io.idwall.formatter.application.domain.User;
import io.idwall.formatter.application.repository.AuthorityRepository;
import io.idwall.formatter.application.repository.UserRepository;
import io.idwall.formatter.application.security.AuthoritiesConstants;
import io.idwall.formatter.application.service.MailService;
import io.idwall.formatter.application.service.dto.UserDTO;
import io.idwall.formatter.application.web.rest.errors.ExceptionTranslator;
import io.idwall.formatter.application.web.rest.vm.KeyAndPasswordVM;
import io.idwall.formatter.application.web.rest.vm.ManagedUserVM;
import io.idwall.formatter.application.service.UserService;
...
@SpringBootTest(classes = IdwallFormatterApp.class)
